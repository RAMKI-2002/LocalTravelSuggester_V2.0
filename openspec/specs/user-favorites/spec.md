...
Defines user-scoped place bookmarks from trip suggestions: authenticated CRUD via `/favorites`, flat storage in `user_favorites`, dashboard save affordance, and a dedicated Favorites page. Implemented in archived change `openspec/changes/archive/2026-06-03-add-user-favorites/`.
